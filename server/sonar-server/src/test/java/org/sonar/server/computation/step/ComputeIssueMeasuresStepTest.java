...
public class ComputeIssueMeasuresStepTest {
  ...
  public void compute_measures_on_new_issue() throws Exception {
    ...
    periodsHolder.addPeriod(newPeriod(3, 1420088400000L));
  ...
  public void do_not_take_into_account_issue_from_current_analysis_when_computing_measures_on_new_issue() throws Exception {
    ...
    periodsHolder.addPeriod(newPeriod(1, 1420088400000L));
  ...
  public void compute_measures_on_new_issue_on_every_variations() throws Exception {
    ...
    addIssues(FILE.getRef(),
      ...
      createIssue(STATUS_OPEN, BLOCKER, null, RULE_1.getKey(), 1433131200000L));
    periodsHolder.addPeriod(newPeriod(1, 1420088400000L)); // 2015-01-01
    periodsHolder.addPeriod(newPeriod(2, 1422766800000L)); // 2015-02-01
    periodsHolder.addPeriod(newPeriod(3, 1425186000000L)); // 2015-03-01
    periodsHolder.addPeriod(newPeriod(4, 1427860800000L)); // 2015-04-01
    periodsHolder.addPeriod(newPeriod(5, 1430452800000L)); // 2015-05-01
  ...
  private static Period newPeriod(int index, long date) {
    return new Period(index, null, null, date);
  }
